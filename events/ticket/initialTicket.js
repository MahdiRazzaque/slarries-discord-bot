        ...
        switch (customId) {
            case "slayer-ticket":
                ...
                .then(async(channel) => {
                    ...
                    channel.send({content: `Welcome <@${interaction.user.id}> ||<@&917054077869912177>||`, embeds: [Embed], components: [Buttons]})
            ...
            case "dungeon-ticket":
                ...
                .then(async(channel) => {
                    ...
                    channel.send({content: `Welcome <@${interaction.user.id}> ||<@&925013507546693632>||`, embeds: [Embed], components: [Buttons]})
