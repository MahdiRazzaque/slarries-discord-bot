        ...
        switch(interaction.options.getSubcommand()) {
            case "bedwars":
                hypixel.getPlayer(player).then((player) => {
                    ...
                    const bedwarsEmbeds = [bedwarsOverall, bedwarsSolos, bedwarsDoubles, bedwarsThrees, bedwarsFours, bedwarsFourVFour];
                    ...
                    interaction.reply({ embeds: [new MessageEmbed().setColor(minecraft_embed_colour).setDescription(`<a:animated_tick:925091839030231071> Here are ${player}'s bedwars stats.`).setFooter({text: "The buttons will expire in 60 seconds."})], allowedMentions: { repliedUser: false } })
                }).catch(e => {
