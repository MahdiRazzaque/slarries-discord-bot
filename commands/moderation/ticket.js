        ...
        switch (Action) {
            case "add":
                DB.findOne({ GuildID: guildId, ChannelID: channel.id }, async (err, docs) => {
                    ...
                    interaction.reply({ embeds: [Embed.setColor(system_embed_colour).setDescription(`${client.emojisObj.animated_tick} ${Member} has been added to this ticket.`)]})
            ...
            case "remove":
                DB.findOne({ GuildID: guildId, ChannelID: channel.id }, async (err, docs) => {
                    ...
                    interaction.reply({ embeds: [Embed.setColor(system_embed_colour).setDescription(`${client.emojisObj.animated_tick} ${Member} has been removed to this ticket.`)]})
