...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try{
            ...
            return interaction.reply({ embeds: [new MessageEmbed().setColor(music_embed_colour).setDescription(`🔁 Repeat Mode has been set to: ${Mode2 = Mode2 ? Mode2 == 2 ? "Queue": "Song" : "Off"}`)]});
